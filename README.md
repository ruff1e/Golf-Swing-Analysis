...
SwingVision is a full-stack AI SaaS project that I designed to provide golfers with AI powered swing analysis.   
The platform combines automated pose estimation with professional coaching feedback through an asynchronous processing pipeline.   
...
- Asynchronous AI Processing: Video files are processed in the background using a decoupled Python worker to ensure the web server remains responsive.   
...
- Media Engineering: Integrated FFmpeg pipeline to ensure cross-browser compatibility for AI-generated media.
